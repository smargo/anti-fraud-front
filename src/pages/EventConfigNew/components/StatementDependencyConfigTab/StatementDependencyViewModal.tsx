...
import type { StatementDependencyViewModalProps } from '../../types';
...
const StatementDependencyViewModal: React.FC<StatementDependencyViewModalProps> = ({
  ...
  if (!viewingStatementDependency) return null;

  return (
    <Modal title="语句依赖详情" open={visible} onCancel={onCancel} footer={null} width={800}>
