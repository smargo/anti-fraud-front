...
import { Button, Space, Tooltip, Modal, message, Popconfirm, Card, Row, Col, Tag, Typography } from 'antd';
import { PlusOutlined } from '@ant-design/icons';
import moment from 'moment';
import { queryEventIndicatorsWithNames, createEventIndicator, updateEventIndicator, deleteEventIndicator } from '../../services/eventIndicatorConfigApi';
...
const EventIndicatorConfigTab: React.FC<EventIndicatorConfigTabProps> = ({
  ...
  const [editingEventIndicator, setEditingEventIndicator] = React.useState<EventIndicatorItem | null>(null);
